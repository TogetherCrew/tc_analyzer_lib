...
class TestNetworkGraphThreeMonthRunOnceAnalytics(IsolatedAsyncioTestCase):
    async def test_networkgraph_three_months_period_run_once_available_analytics(self):
        """
